...
public enum ResultCode {
    ...
    NOT_FOUND_USER(HttpStatus.NOT_FOUND, 201, "존재하지 않는 사용자 입니다."),
    ...
    // 메이트 관련 5000번대
    NOT_FOUND_MATE(HttpStatus.NOT_FOUND, 5000, "해당 맛집메이트 글을 찾을 수 없습니다."),
    NOT_FOUND_APPLY(HttpStatus.NOT_FOUND, 5001, "해당 맛집메이트 신청기록을 찾을 수 없습니다."),
    NOT_FOUND_MATEMEMBER(HttpStatus.NOT_FOUND, 5002, "해당 맛집메이트의 멤버를 찾을 수 없습니다."),

    // 장소 6000번대
    NOT_FOUND_PLACE(HttpStatus.NOT_FOUND, 6000, "해당 장소를 찾을 수 없습니다.");
